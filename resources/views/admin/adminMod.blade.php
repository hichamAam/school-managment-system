...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route('admin.profil')}}">User Profile</a></li>
...
<div class="container card shadow p-4" style="margin-bottom: 10px;">
        ...
        @method('PUT')
            ...
            <div class="col-md-8 col-lg-9">
                <input name="id" type="text" class="form-control" value="{{$admin->id}}" readonly>
            </div>
            </div>
            ...
            <div class="col-md-8 col-lg-9">
                <div class="input-group mb-3">
                    <input type="text" aria-label="Last name" class="form-control" name="prenom" placeholder="Prenom" value="{{$admin->prenom}}" require>
                    <input type="text" aria-label="First name" class="form-control" name="nom" placeholder="Nom" value="{{$admin->nom}}" require>
                </div>
            </div>
            </div>
            ...
            <div class="col-md-8 col-lg-9">
                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="notell" value="{{$admin->tel}}" require>
            </div>
            </div>
            ...
            <div class="col-md-8 col-lg-9">
                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="email" value="{{$admin->email}}" require>
            </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="text-center">
                ...
                <a href="{{route('admin.profil')}}" class="btn btn-danger">Annuler</a>
            </div>
        </form>
    </div>
@endsection