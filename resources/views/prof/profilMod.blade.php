...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{route('prof.profil')}}">User Profile</a></li>
...
<div class="container card shadow p-4" style="margin-bottom: 10px;">
        ...
        @method('PUT')
            ...
            <div class="col-md-8 col-lg-9">
                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="tel" value="{{$prof->tel}}" require>
            </div>
            </div>
            ...
            <div class="col-md-8 col-lg-9">
                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="email" value="{{$prof->email}}" require>
            </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="text-center">
                ...
                <a href="{{route('prof.profil')}}" class="btn btn-danger">Annuler</a>
            </div>
        </form>
    </div>
@endsection